...
document.addEventListener("pywebviewready", () => {
    ...
    elements.btnMinimize.addEventListener("click", () => window.pywebview.api.minimize());
    elements.btnClose.addEventListener("click", () => window.pywebview.api.close());
    setupDragDrop();
});
...
async function startScan(filePath) {
    ...
    const resultJson = await window.pywebview.api.scan_file(filePath);
